...
$$
 Y \sim \text{NB}(r=2, \mu = exp(\beta_0 + \beta_1x_1 + \beta_2x_2)).
$$
Consequently, using a Poisson GLM would result in the violation of the model assumption. 
...
We manually enlarged three outcomes by adding values of 10, 15, and 20 to them, respectively. In the right panel above, we can see the three modified data points stand out, signaling they are potential outliers.
