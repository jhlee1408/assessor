---
title: "resid_disc(): Discrete outcome"
---
...
```
We simulate the ordinal random variable $Y$ which takes on the values $0,1$ and $2$ with probabilities depending on $x_1$. Given the simulation setting, an appropriate model to use is `model1`.
