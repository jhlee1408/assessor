...
`dpit()` is used for calculating the DPIT residuals for regression models with zero-inflation outcomes, and `plot()` draws corresponding QQ-plots from the returned objects. The suitable model objects are as follows:
