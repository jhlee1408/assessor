...
Calculates DPIT residuals for regression models with non-continuous
outcomes. In particular, model assumptions for GLMs with discrete
outcomes (e.g., binary, Poisson, and negative binomial), ordinal
regression models, zero-inflated regression models, and semicontinuous
outcome models can be assessed using `dpit()`.
...
- **Discrete outcomes**
  ...
  - [`glm`](https://rdrr.io/r/stats/glm.html) with `family = poisson()`
    (see
    [`dpit_pois`](https://jhlee1408.github.io/assessor/reference/dpit_pois.md)).

  - [`glm.nb`](https://rdrr.io/pkg/MASS/man/glm.nb.html) for negative
    binomial regression (see
    [`dpit_nb`](https://jhlee1408.github.io/assessor/reference/dpit_nb.md)).

  - [`polr`](https://rdrr.io/pkg/MASS/man/polr.html) for ordinal
    outcomes (see
    [`dpit_ordi`](https://jhlee1408.github.io/assessor/reference/dpit_ordi.md)).

- **Zero-inflated discrete outcomes**

  - [`zeroinfl`](https://rdrr.io/pkg/pscl/man/zeroinfl.html) with
    `dist = "poisson"` (see
...
- **Semicontinuous outcomes**
  ...
  - Tobit regression via
    [`tobit`](https://rdrr.io/pkg/AER/man/tobit.html) from `AER` or
    [`vglm`](https://rdrr.io/pkg/VGAM/man/vglm.html) from `VGAM` (see
    [`dpit_tobit`](https://jhlee1408.github.io/assessor/reference/dpit_tobit.md)).

  - Tweedie regression via [`glm`](https://rdrr.io/r/stats/glm.html)
    with a Tweedie family (see
